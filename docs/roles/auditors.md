...
- A company with a stable price is rated Low risk.
- A company whose price has moved sharply up or down over recent cycles is rated High risk.
- On any review the auditor may uncover a hidden issue: rarely on a stable company, and more often after a sharp move.
- A hidden issue raises the verdict to Extra risk and drops the share price by a set range.
