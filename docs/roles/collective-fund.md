...
- An active fund buys and sells automatically, but normally keeps 10% of its worth as a cash buffer for member deposits. From the trading day before any member becomes leave-eligible, and while a departure remains possible, its automated buying uses a 15% buffer instead. Fund decisions retain their personality-, momentum-, and order-book-aware pricing and may rest in the allowed waiting range; the Individual and AI Agent automated-buy policy does not apply. Cash-raising and liquidation sells are clamped into the executable band so they can cross. See [LULD price controls](../rules/luld.md).
