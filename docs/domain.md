...
- A market crisis can strike at random, driving selected industries down and leaving a temporary risk-off interval. See [Market crises](logic/crisis.md) for its trigger, impact, and timeline rules.
...
- The scope-specific trigger, price-impact, active-window, and consequence rules are documented in [Market crises](logic/crisis.md).
